...
<div class="ui secondary {if isset($NAVBAR_SIZE)}{$NAVBAR_SIZE}{else}small{/if} menu" id="navbar"
    ...
    <div class="ui container">
        ...
        <div class="ui pointing dropdown link item">
            ...
            <span class="text" style="color:black">{$item.icon} {$item.title}</span> <i class="dropdown icon"
                style="color:black"></i>
            {else}
            <span class="text" style="color:white">{$item.icon} {$item.title}</span> <i class="dropdown icon"
                style="color:white"></i>
            {/if}
            <div class="menu">
